...
class InstagramBot:
    ...
    def login(self):
        ...
        self.comente_nas_fotos_com_a_hashtag()  # Altere aqui para a hashtag que você deseja usar.
    ...
    def comente_nas_fotos_com_a_hashtag(self):
        links_de_posts = []
        driver = self.driver
        driver.get("https://www.instagram.com/explore/tags/" + self.search + "/")
        time.sleep(5)

        for i in range(self.qtdeScroll):
        ...
        for pic_href in links_de_posts:
            ...
            try:
                # separado por um split no ;
                comments = ("Que maneiro ; muito bacana ; Que legal! ; Interessante").split(sep=" ; ")
